...
public class TestMatrixData {
  ...
  public static final IDoubleMatrix ROW_2X2 = row(2, 20, 21);

  public static final IDoubleMatrix COLUMN_3X3 = column(3, 22, 23, 24);

  public static final IDoubleMatrix CONSTANT_3X2 = constant(matrix(3, 2), 25);
}
